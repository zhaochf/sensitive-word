...
public class SensitiveWordHelperTest {
   ...
   public void findAllRawTest() {
        ...
        assertEquals("[WordResult{startIndex=0, endIndex=4, type='WORD'}, WordResult{startIndex=9, endIndex=12, type='WORD'}, WordResult{startIndex=18, endIndex=21, type='WORD'}]", wordList.toString());
    }
   ...
   public void findFirstRawTest() {
        ...
        assertEquals("WordResult{startIndex=0, endIndex=4, type='WORD'}", word.toString());
    }
